...
//
//// @Disabled("구현중") - test 사용하지 않을거면 사용 
//@DisplayName("View 컨트롤러 - 게시글")
//@Import({TestSecurityConfig.class, FormDataEncoder.class})
//@WebMvcTest(ArticleController.class) // 입력한 class controller 만 호출하여 test 
...
//                .andExpect(status().isOk()) // 정상 호출 되었는지 
//                .andExpect(content().contentTypeCompatibleWith(MediaType.TEXT_HTML)) // content type 설정 (contentTypeCompatibleWith - 호환)
//                .andExpect(view().name("articles/index")) // index에 view가 있어야한다. (templates.articles - index.html)
//                .andExpect(model().attributeExists("articles")) // articles 안에 model attribute data가 있는지 
